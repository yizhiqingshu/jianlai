#ifndef __ENCODER2_TIM_H__
#define __ENCODER2_TIM_H__
...
/* 使用A3 B3 */
#ifdef  Encode_3
#define ENCODER3_TIMx                        TIM1
#define ENCODER3_TIM_RCC_CLK_ENABLE()        __HAL_RCC_TIM1_CLK_ENABLE()
#define ENCODER3_TIM_RCC_CLK_DISABLE()       __HAL_RCC_TIM1_CLK_DISABLE()

#define ENCODER3_TIM_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOA_CLK_ENABLE()
#define ENCODER3_TIM_CH1_PIN                 GPIO_PIN_8
#define ENCODER3_TIM_CH1_GPIO                GPIOA
#define ENCODER3_TIM_CH2_PIN                 GPIO_PIN_9
#define ENCODER3_TIM_CH2_GPIO                GPIOA
#define ENCODER3_TIM_GPIO_AFx                GPIO_AF1_TIM1
#define TIM1_ENCODERMODE_TIx                 TIM_ENCODERMODE_TI12
...
#define ENCODER2_TIM_PRESCALER               0  // 实际时钟频率为：36kHz
